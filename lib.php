...
function taskflowadapter_ksw_render_navbar_output(\renderer_base $renderer) {
    ...
    $items = [
        ['label' => get_string('mandant1', 'taskflowadapter_ksw'), 'link' => '/course/index.php?categoryid=10'],
        ['label' => get_string('mandant2', 'taskflowadapter_ksw'), 'link' => '/course/index.php?categoryid=11'],
