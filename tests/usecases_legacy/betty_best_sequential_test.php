 ...
 *
 */
final class betty_best_sequential_test extends advanced_testcase {
    ...
    public function test_betty_best(): void {
        ...
        $secondcoursecontext = context_course::instance($secondcourse->id);
        $this->assertFalse(is_enrolled($secondcoursecontext, $user->id));
        $thirdcoursecontext = context_course::instance($thirdcourse->id);
        $this->assertFalse(is_enrolled($thirdcoursecontext, $user->id));
        ...
        $taskadhocmessages = $DB->get_records('task_adhoc');
        $thirdcoursecontext = context_course::instance($thirdcourse->id);
        $this->assertTrue(is_enrolled($thirdcoursecontext, $user->id));
