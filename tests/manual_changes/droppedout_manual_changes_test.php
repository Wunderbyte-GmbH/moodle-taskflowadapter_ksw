 ...
 */
final class droppedout_manual_changes_test extends manual_changes_base {
    /**
    ...
    public function test_manual_change(
        ...
        // Set user2 to droppedout by removing from orgunit.
        $user = $DB->get_record('user', ['id' => $user2->id]);
        profile_load_custom_fields($user);
        $user->profile_field_orgunit = '';
        $user->profile_field_Org1 = '';
        ...
        $this->assertSame((int)$assignment->status, assignment_status_facade::get_status_identifier('droppedout'));
