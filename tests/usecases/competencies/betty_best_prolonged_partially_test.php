 ...
 */
final class betty_best_prolonged_partially_test extends advanced_testcase {
    ...
    public function test_betty_best_user_update_after_partial_completion(array $bdata): void {
        ...
        $prolongedassignment = $DB->get_record('local_taskflow_assignment', ['id' => $assignment->id ]);
        $this->assertSame((int)$prolongedassignment->status, assignment_status_facade::get_status_identifier('prolonged'));
        ...
        $this->assertSame($initialcount + 5, $countafter);
