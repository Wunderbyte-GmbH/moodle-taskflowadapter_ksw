 ...
 */
final class betty_best_completion_after_overdue_test extends advanced_testcase {
     ...
     */
    public function test_betty_best_completion_after_overdue(array $bdata): void {
        global $DB;
