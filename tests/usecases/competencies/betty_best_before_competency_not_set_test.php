 ...
 */
final class betty_best_before_competency_not_set_test extends advanced_testcase {
    ...
    public function test_assign_competency_on_option_completion(array $bdata): void {
        ...
        // Rule contains competency 1, so we set the wrong competency here.
        ...
        $this->assertCount(1, $historylogs);
