...
final class paul_planned_mock_completed_test extends advanced_testcase {
    ...
    public function test_paul_planned(): void {
        ...
        // Course completed -> Assignment should not change.
        foreach ($users as $userid) {
            $this->course_completed($course->id, $userid);
        }
        ...
        foreach ($assignemnts as $assignment) {
            ...
            $this->assertEquals(assignment_status_facade::get_status_identifier('completed'), $completedassignemnt->status);
        }
    }
